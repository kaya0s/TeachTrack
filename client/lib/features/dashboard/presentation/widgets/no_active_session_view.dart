          ...
          child: ListView(
            ...
            children: [
              ...
              _MethodologyStep(
                ...
                title: "AI Detection",
                desc: "The system identifies all students currently in the camera's view. This becomes the 'Sample' used for the engagement score.",
                theme: theme,
              ),
              _MethodologyStep(
                step: "2",
              ...
              _MethodologyStep(
                ...
                desc: "The final score is calculated by dividing the engagement quality of visible students by the total students currently seen.",
                theme: theme,
                isLast: true,
              ),
              ...
              const SizedBox(height: 8),
              Text(
                "Because your camera may not see every student in the room, we focus only on those in view. This ensures the score accurately reflects the engagement of the students you are actually monitoring.",
