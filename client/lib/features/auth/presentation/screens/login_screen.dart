      ...
      child: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            const footerReservedHeight = 84.0;
            return SizedBox(
                      ...
                      child: SingleChildScrollView(
                        child: ConstrainedBox(
                          constraints: BoxConstraints(
                            minHeight: (constraints.maxHeight - footerReservedHeight).clamp(0, double.infinity),
                          ),
                          child: Center(
                            child: ConstrainedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "AI-powered student classroom behavior monitoring.",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                          ...
                                          SizedBox(
                                            ...
                                            child: Checkbox(
                                              ...
                                              onChanged: auth.status == AuthStatus.authenticating
                                                  ? null
                                                  : (value) => context.read<AuthProvider>().setRememberMe(value ?? true),
                                            ),
                                          ),
                    ...
                    Padding(
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          Text(
                            "Proudly made for the College of Arts and Sciences",
                            textAlign: TextAlign.center,
                            style: TextStyle(
